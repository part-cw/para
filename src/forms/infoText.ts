...
export const rrateButtonInfo = 'Manually count breaths per minute.'
...
export const spo2DischargeInfo = "Measure the patient's oxygen saturation prior to discharge.\n\nDO NOT re-use the measurements collected at admission."